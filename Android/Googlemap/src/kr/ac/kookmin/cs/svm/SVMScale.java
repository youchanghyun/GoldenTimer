...
class SVMScale {
	...
	public void run(String inputFile, String restoreFile, String outputFile, String scaledInputFile,
		...
		if(scaledInputFile != null)
			out = new BufferedWriter(new FileWriter(scaledInputFile));
		while (readline(fp) != null) {
			int next_index = 1;
			double target;
			double value;
			...
			if(out != null)
				out.write(Double.toString(target));
