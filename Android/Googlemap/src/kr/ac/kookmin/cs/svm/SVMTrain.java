...
class SVMTrain {
	private static final String TAG = "SVMTrain";
	...
	public void run(String inputFile, String outputFile, String option[])
			throws IOException {
		parse_command_line(inputFile, outputFile, option);
		read_problem();
	...
	private void parse_command_line(String inputFile, String outputFile,
			String option[]) {
		int i;
		...
		for (i = 0; i < optionLen; i++) {
			...
			case 's':
				param.svm_type = atoi(option[i]);
				break;
			case 't':
				param.kernel_type = atoi(option[i]);
				break;
			case 'd':
				param.degree = atoi(option[i]);
				break;
			case 'g':
				param.gamma = atof(option[i]);
				break;
			case 'r':
				param.coef0 = atof(option[i]);
				break;
			case 'n':
				param.nu = atof(option[i]);
				break;
			case 'm':
				param.cache_size = atof(option[i]);
				break;
			case 'c':
				param.C = atof(option[i]);
				break;
			case 'e':
				param.eps = atof(option[i]);
				break;
			case 'p':
				param.p = atof(option[i]);
				break;
			case 'h':
				param.shrinking = atoi(option[i]);
				break;
			case 'b':
				param.probability = atoi(option[i]);
				break;
			case 'q':
			...
			case 'w':
				...
				param.weight_label[param.nr_weight - 1] = atoi(option[i - 1]
						.substring(2));
				param.weight[param.nr_weight - 1] = atof(option[i]);
				break;
			default:
